...
@Test
@TestAreas({"dockermanager", "localecosystem", "java17", "ubuntu"})
@Tags({"codecoverage"})
public class DockerLocalJava17Ubuntu extends AbstractDockerUbuntuLocal {
	...
	@LinuxImage(imageTag = "DOCKER", operatingSystem = OperatingSystem.ubuntu)
